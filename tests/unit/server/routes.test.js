...
describe('#Routes - test suite for API response', () => {
  ...
  test(`GET /home - it respond with ${pages.homeHTML} file stream`, async () => {
    const params = TestUtil.defaultHandleParams()
    params.request.method = 'GET'
  ...
  test(`GET /controller - it respond with ${pages.controllerHTML} file stream`, async () => {
    const params = TestUtil.defaultHandleParams()
    params.request.method = 'GET'
  ...
  test(`GET /index.html - it respond with file stream`,  async ()  => {
    const params = TestUtil.defaultHandleParams()
  ...
  test(`GET /file.ext - it respond with file stream`,  async ()  => {
    const params = TestUtil.defaultHandleParams()
  ...
  test(`POST /unknown - given an inexistent route it respond with 404`, async () => {
    const params = TestUtil.defaultHandleParams()
  ...
  describe('exceptions', () => {
    test('given inexistent file it respond with 404', async () => {
      const params = TestUtil.defaultHandleParams()
      params.request.method = 'GET'
    ...
    test('given an error file it respond with 500', async () => {
      const params = TestUtil.defaultHandleParams()
      params.request.method = 'GET'
      params.request.url = '/index.png'
      jest.spyOn(
